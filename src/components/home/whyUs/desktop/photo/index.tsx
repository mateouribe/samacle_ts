  ...
  return (
    ...
    >
      <div className="w-full h-full relative px-[30px] py-[50px]">
        <div
          className="absolute w-[calc(100%-60px)] h-[calc(100%-100px)] lg:w-[calc(100%-100px)] lg:h-[calc(100%-200px)] left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2"
          style={{
